export const car_data_1 = [
    ...
    },
    {
        ...
        description: "High-performance luxury sedan with a powerful V8 engine and sport-tuned suspension.",
        description_ru: "Высокопроизводительный люксовый седан с мощным V8 двигателем.",
        features: [
            "5.0L V8 Engine",
            "Premium leather interior",
    ...
    },
    {
        ...
        description: "Luxury electric sedan with premium comfort and advanced technology. Elegant gray color.",
        description_ru: "Роскошный электрический седан с премиальным комфортом и передовыми технологиями. Элегантный серый цвет.",
        features: [
            "Long-range battery (700+ km)",
            "Air suspension",
            "Premium leather interior",
    ...
    },
    {
        ...
        description: "Luxury full-size SUV with powerful V8 engine and premium comfort features.",
        description_ru: "Роскошный полноразмерный внедорожник с мощным V8 двигателем и премиальным комфортом.",
        features: [
            "5.7L V8 Engine",
            "Premium leather interior",
            "Mark Levinson audio system",
